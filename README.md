...
これは、このアプリが Apple Developer Program（有料）での署名をしていないために表示されるもので、**マルウェアが検知されたわけではなく、開発元が証明されていないという意味**です。ソースコードは [GitHub で全公開](https://github.com/sasakireijiyagi/video-cut-editor)、外部への通信も一切ありません。安心してご利用ください。
